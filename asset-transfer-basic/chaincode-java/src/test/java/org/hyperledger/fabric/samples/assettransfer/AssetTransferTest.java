...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Asset asset = contract.DuplicateAsset(ctx, "asset1", "asset9", "Janani");

            assertThat(asset).isEqualTo(new Asset("asset9", "blue", 45, "Janani", 60));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "asset9", "Janani");
            });
